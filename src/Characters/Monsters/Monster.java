...
public class Monster implements Character{
    ...
    public boolean dodge() { // dodge damage
        ...
        return RandomGenerator.TrueFalseGen(dodge_probability); // return true if successfully dodge
    }
    ...
    public void takeDamage(int damage , Character hero) { // take damage by Hero
        ...
        HP = HP - revise_damage;
        PrintPrompt.attactPrint(hero, this, revise_damage); // print get damage
        if(!checkAlive()){
            dead();
        }
    }
